...
public class MutableIntSetTest
{
    ...
    public void withAndWithout()
    {
        ...
        MutableIntSet setWith = this.set.with(6).with(7);
        ...
        MutableIntSet setWithAll = this.set.withAll(IntLists.immutable.with(8, 9, 10));
        ...
        MutableIntSet setWithout = this.set.without(9).without(10);
        ...
        MutableIntSet setWithoutAll = this.set.withoutAll(IntLists.immutable.with(6, 7, 8));
    ...
    public void select()
    {
        ...
        MutableIntSet evens = this.set.select(each -> each % 2 == 0);
    ...
    public void reject()
    {
        ...
        MutableIntSet odds = this.set.reject(each -> each % 2 == 0);
    ...
    public void collect()
    {
        ...
        MutableSet<String> collect = this.set.collect(String::valueOf);
    ...
    public void toList()
    {
        MutableIntList list = this.set.toList();
    ...
    {
        MutableIntSet intersect = this.set.intersect(IntSets.mutable.with(4, 5, 6));
    ...
    public void union()
    {
        MutableIntSet union = this.set.union(IntSets.mutable.with(4, 5, 6));
    ...
    {
        MutableIntSet difference = this.set.difference(IntSets.mutable.with(4, 5, 6));
